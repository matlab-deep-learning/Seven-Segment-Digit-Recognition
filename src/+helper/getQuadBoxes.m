function bboxes = getQuadBoxes(textmap, linkmap, textThreshold, linkThreshold, lowText)
    % This function generates bounding boxes as, an M-by-4 matrix.
    % Each row of bboxes contains a four-element vector, [x, y, w, h].
    % This vector specifies the upper-left corner and size of a
    % rectangular region of interest in pixels.
    %
    ...
    %   make clock-wise order
        ...
        h = norm(boxes(k,[5 6]) - boxes(k,[3 4]));
        
        bboxes = [bboxes;[boxes(k,1) boxes(k,2) w h]];
